...
/**
 	* A data access object (DAO) providing persistence and search support for Htmls entities.
...
public class HtmlsDAO extends BaseHibernateDAO  {
    ...
    public Htmls findById( java.lang.Integer id) {
        ...
        try {
            Htmls instance = (Htmls) getSession()
                    .get("com.qiang.bean.Htmls", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByExample(Htmls instance) {
        ...
        try {
            List results = getSession()
                    .createCriteria("com.qiang.bean.Htmls")
